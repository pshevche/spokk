 ...
 */
class SpockkRunConfigurationProducerTest : LightJavaCodeInsightFixtureTestCase() {

    private lateinit var producer: SpockkRunConfigurationProducer

    override fun setUp() {
        super.setUp()
        producer = SpockkRunConfigurationProducer()
    }

    override fun getTestDataPath(): String {
        val path = Paths.get("./src/test/resources/SpockkRunConfigurationProducerTest/").toAbsolutePath()
    ...
    }, "SpockkRunConfigurationProducerTest")
        ...
        assertThat(
            ...
            equalTo(
                listOf(
                    ...
                    "--tests",
                    "'io.github.pshevche.spockk.samples.SimpleSpec'"
                )
            )
        )
        ...
        assertThat(
            ...
            equalTo(
                listOf(
                    ...
                    "--tests",
                    "'io.github.pshevche.spockk.samples.SimpleSpec.successful feature'"
                )
            )
        )
        assertTrue(producer.isConfigurationFromContext(configuration, defaultContext()))
    ...
    fun testConfigurationIsRefreshedIfModuleChanges() {
        ...
        val previousConfiguration = mockGradleConfiguration("testConfigurationIsRefreshedIfModuleChanges").apply {
            settings.taskNames = listOf(":otherModule:test", "--tests", "'io.github.pshevche.spockk.samples.SimpleSpec'")
        }
    ...
    fun testConfigurationIsRefreshedIfSpecChanges() {
        ...
        val previousConfiguration = mockGradleConfiguration("testConfigurationIsRefreshedIfSpecChanges").apply {
            settings.taskNames = listOf(
                ...
                "--tests",
                "'io.github.pshevche.spockk.samples.OtherSpec'"
            )
        }
    ...
    fun testConfigurationIsRefreshedIfFeatureChanges() {
        ...
        val previousConfiguration = mockGradleConfiguration("testConfigurationIsRefreshedIfFeatureChanges").apply {
            settings.taskNames = listOf(
                ...
                "--tests",
                "'io.github.pshevche.spockk.samples.SimpleSpec.other feature'"
            )
        }
