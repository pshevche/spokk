...
import io.github.pshevche.spockk.intellij.extensions.requiredFqn
...
class SpockkRunConfigurationProducer : GradleRunConfigurationProducer() {
    ...
    private fun taskNames(
        ...
        val modulePath = requireNotNull(module.externalProjectPath) {
            "Cannot determine the module path to run Spockk tests"
        }
        val moduleName = modulePath.substring(modulePath.lastIndexOf(SystemPathSeparator) + 1)

        // TODO https://github.com/pshevche/spockk/issues/68
