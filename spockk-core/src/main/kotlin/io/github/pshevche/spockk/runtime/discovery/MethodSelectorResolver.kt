...
internal class MethodSelectorResolver : SelectorResolver {
    ...
    /**
     * Method is a spockk feature if the declaring class is a spockk spec, the method is annotated with `FeatureMetadata`
    ...
    /**
     * Requested unique ID corresponds to a spockk feature if the segment type is "feature",
     * parent descriptor is a spockk spec, the method is annotated w/ `FeatureMetadata`, and the unique ID
