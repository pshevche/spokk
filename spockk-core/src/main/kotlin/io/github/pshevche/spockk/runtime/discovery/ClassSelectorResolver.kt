...
package io.github.pshevche.spockk.runtime.discovery

import io.github.pshevche.spockk.runtime.SpockkException
import io.github.pshevche.spockk.runtime.node.FeatureInfo
import io.github.pshevche.spockk.runtime.node.FeatureNode
import io.github.pshevche.spockk.runtime.node.SpecInfo
import io.github.pshevche.spockk.runtime.node.SpecNode
...
internal class ClassSelectorResolver(private val classNameFilter: (String) -> Boolean) : SelectorResolver {
    ...
    /**
     * The requested class is recognized by the "spockk" engine if it has the `SpecMetadata` annotation.
     */
    ...
    /**
     * The requested uniqueId is a "spockk" spec class if its type is "spec" and the referenced class
    ...
    override fun resolve(selector: UniqueIdSelector, context: SelectorResolver.Context): Resolution {
        ...
        if (UniqueIdUtil.isSpec(uniqueId)) {
            val specClass = ReflectionSupport.tryToLoadClass(uniqueId.lastSegment.value)
                .getOrThrow { SpockkException("Failed to load class from UniqueIDSelector $uniqueId") }
